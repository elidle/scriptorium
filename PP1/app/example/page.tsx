        ...
        <div className="bg-white dark:bg-gray-800 min-h-screen w-full">
            ...
            {/* <AppBar position="static">
                <Toolbar className="w-full py-3 border-b bg-blue-500 dark:bg-gray-800">
                    <div className='flex justify-evenly px-20 items-center font-semibold w-full'>
            ...
            <AppBar position="static">
                <Toolbar className="w-full py-3 border-b bg-blue-500 dark:bg-gray-800">
                    <div className="flex justify-between items-center w-full font-semibold">
                        ...
                        {/* Right Section */}
                        <button className="py-2 px-6 bg-black text-white rounded-3xl font-semibold ml-auto">
                            Log in
                        </button>
                    </div>
                </Toolbar>
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="md:w-2/3 md:pl-8">
                            ...
                            <div className="flex flex-wrap gap-2 mb-6">
                                <span className="bg-indigo-100 text-indigo-800 px-3 py-1 rounded-full text-sm">Admin</span>
                            </div>
